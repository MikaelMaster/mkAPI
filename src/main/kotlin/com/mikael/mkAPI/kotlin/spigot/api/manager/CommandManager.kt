...
open class CommandManager(var name: String, vararg aliases: String) : EventsManager(), TabCompleter, CommandExecutor {
    ...
    var usagePrefix: String = "§cUsage: "
    var description = "This command do somehting."
    var permission: String = ""
    var usage: String = ""
    var aliases: List<String> = ArrayList()
    var permissionMessage = "§cYou don't have permission to use this command."
        ...
        override fun execute(sender: CommandSender, label: String, args: Array<String>): Boolean {
            try {
                if (!command.plugin.isEnabled) {
                    sender.sendMessage("§cO plugin ${command.plugin.name} foi desabilitado.")
                    return false
                }
                if (sender.hasPermission(permission)) {
